...
const storeInMechine = async (req, res) => {
  ...
  try {
    ...
    const insertQ = "insert into tbl_tts_record(tts_id,title,tts_text,audio_key,qr_key,duration,tts_generated,llm_name) values ($1,$2,$3,$4,$5,$6,$7,$8);";
    await pgClient.query(insertQ, [nextTtsId, title, text, audioFilename, fileName, duration, "YES",llm_code]);
