...
import { createSpeechOnlyForCron, formatToISODuration, generateCmykQr, saveQRImage } from "../controller/ttsController-gcp.js";
...
const getNoTtsGeneratedData=async()=>{
    const getQ="SELECT tts_id,title,tts_text,tts_generated,audio_key from tbl_tts_record where tts_generated='NO'or tts_generated='NEED UPDATE' order by tts_time limit 1;";
    try {
